...
if __name__ == "__main__":
    output = text_to_speech(
        "Witajcie w naszym edukacyjnym podkaście "
        "poświęconym "
        "fascynującemu światu słoni. "
        "Dziś zanurzymy się w niezwykłe cechy tych majestatycznych stworzeń, "
        "ich zachowania oraz rolę, jaką odgrywają"
        " w ekosystemach na całym świecie.",
    )
