...
class TestAzureTTSPodcastGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.env_patcher = patch.dict(
            os.environ,
            {"AZURE_SPEECH_API_KEY": self.api_key, "AZURE_SPEECH_REGION": self.region},
        )
    ...
    def test_init_missing_api_key(self):
        ...
        with patch.dict(os.environ, {"AZURE_SPEECH_API_KEY": ""}, clear=True):
            ...
            self.assertIn("Missing AZURE_SPEECH_API_KEY", str(context.exception))
    ...
    def test_generate_podcast_empty_dialog_data(
        ...
        with patch.object(generator.logger, "error") as mock_logger_error:
            ...
            mock_logger_error.assert_called_once_with("No dialog data provided.")
    ...
    def test_generate_podcast_synthesis_error(
        ...
        with patch.object(generator.logger, "error") as mock_logger_error:
            with patch.object(
                ...
                mock_logger_error.assert_called_with("Synthesis error for segment 1")
...
class TestAzureTTSPodcastGeneratorIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.env_patcher = patch.dict(
            os.environ,
            {"AZURE_SPEECH_API_KEY": "test_key", "AZURE_SPEECH_REGION": "test_region"},
        )
        self.env_patcher.start()
